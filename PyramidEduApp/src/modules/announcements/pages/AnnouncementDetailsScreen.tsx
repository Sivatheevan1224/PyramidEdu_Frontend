...
import { fetchAnnouncementDetails } from "../services/announcements.service";
import { getPriorityColor } from "../constants/announcements.constants";

interface AnnouncementDetailsScreenProps {
  id: string;
}

export const AnnouncementDetailsScreen: React.FC<AnnouncementDetailsScreenProps> = ({ id }) => {
