      ...
      <div className="space-y-8 p-4">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-slate-505 mt-1">Create, monitor, and grade subject exams</p>
          </div>
          <Button
                ...
                >
                  <div className="p-7 space-y-5 flex-1">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <p className="text-sm text-slate-505 flex items-center gap-2 mt-1.5 font-medium">
                    ...
                    <div className="grid grid-cols-2 gap-4 text-xs text-slate-600 dark:text-slate-400 font-medium">
                      ...
                      <div className="space-y-1">
                        <span className="text-slate-400 dark:text-slate-505 font-bold block uppercase tracking-wider text-[10px]">Duration</span>
                        <div className="flex items-center gap-1.5 text-slate-700 dark:text-slate-300">
                          <Clock className="w-4 h-4 text-slate-400" />
                      ...
                      <div className="space-y-1">
                        <span className="text-slate-400 dark:text-slate-505 font-bold block uppercase tracking-wider text-[10px]">Marks</span>
                      ...
                      <div className="space-y-1">
                        <span className="text-slate-400 dark:text-slate-505 font-bold block uppercase tracking-wider text-[10px]">Submissions</span>
                        <div className="flex items-center gap-1.5 text-slate-800 dark:text-slate-200 font-bold">
                      ...
                      <div className="space-y-1">
                        <span className="text-slate-400 dark:text-slate-505 font-bold block uppercase tracking-wider text-[10px]">Batch</span>
                        <div className="flex items-center gap-1.5 text-slate-700 dark:text-slate-300">
                      ...
                      {canEdit && (
                        <>
                          <Button
                            variant="ghost"
                            size="icon"
                            className="h-10 w-10 cursor-pointer text-slate-505 hover:text-indigo-600 hover:bg-slate-200/60 dark:hover:bg-slate-800 rounded-xl transition-colors"
                            onClick={(e) => {
                              e.stopPropagation();
                          ...
                          <Button
                            variant="ghost"
                            size="icon"
                            className="h-10 w-10 cursor-pointer text-slate-505 hover:text-rose-600 hover:bg-slate-200/60 dark:hover:bg-slate-800 rounded-xl transition-colors"
