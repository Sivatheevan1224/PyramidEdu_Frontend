...
import { useManagerStudentDetails } from "../hooks/useManagerStudentDetails";

export const ManagerStudentDetails = ({ studentId }: { studentId: string }) => {
  ...
  const {
    ...
    handleApplyFilters,
    clearFilters
  } = useManagerStudentDetails(studentId);
