  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto pb-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            {activeTab === 'my' 
              ? "Manage broadcast notices created for students and staff."
              : "View all broadcasted announcements across the institute."}
          </p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        <StatCard label="Total Broadcasted" value={stats.total.toString()} icon={Bell} accent="primary" />
                  ...
                  return (
                    <tr key={ann.id} className="hover:bg-muted/20 transition-colors">
                      ...
                      <td className="px-6 py-4">
                        <div>
                          <p className="font-semibold text-foreground">{ann.sender?.fullName || "Manager"}</p>
        ...
        <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-xs flex items-center justify-center p-4">
          <Card className="w-full max-w-3xl bg-card border border-border rounded-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200">
            ...
            <form onSubmit={handleSubmit} className="p-6 max-h-[80vh] overflow-y-auto space-y-4 text-left">
              ...
              {/* Upload Attachment */}
              <div className="border rounded-xl p-4 bg-muted/20 border-border">
                <label className="block text-xs font-bold uppercase tracking-wider text-muted-foreground mb-2">Upload Attachment (Optional)</label>
            ...
            <div className="p-6 space-y-5 max-h-[85vh] overflow-y-auto">
              ...
              <div className="flex items-center justify-between p-3.5 border border-border rounded-xl bg-muted/20">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-bold text-foreground">{selectedAnnouncement.sender?.fullName || "Manager"}</p>
              ...
              <div className="grid gap-4 md:grid-cols-2 text-xs">
                <div className="p-4 border border-border rounded-xl bg-muted/20 space-y-2">
                  <p className="font-bold text-muted-foreground uppercase tracking-wider flex items-center gap-1.5"><Users className="w-4 h-4 text-primary" /> Recipient Info</p>
                  <div>
                ...
                <div className="p-4 border border-border rounded-xl bg-muted/20 space-y-2">
                  <p className="font-bold text-muted-foreground uppercase tracking-wider flex items-center gap-1.5"><Calendar className="w-4 h-4 text-primary" /> Dates</p>
                  <div>
